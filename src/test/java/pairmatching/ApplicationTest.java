...
class ApplicationTest extends NsTest {
    ...
    void 매칭_실패() {
        ...
        assertThat(output()).contains(ErrorMessage.MATCHING_FAILURE_ERROR.getErrorMessage());
    }
    ...
    void 매칭_조회_실패() {
        assertSimpleTest(
                () -> {
                    ...
                    assertThat(output()).contains(ErrorMessage.NO_EXIST_MATCHING_ERROR.getErrorMessage());
                }
        );
    }
